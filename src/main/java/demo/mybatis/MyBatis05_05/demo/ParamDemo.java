package demo.mybatis.MyBatis05_05.demo;

import java.util.List;

import demo.mybatis.MyBatis05_05.domain.Teacher;
import demo.mybatis.MyBatis05_05.service.TeacherService;
...
public class ParamDemo
{
    ...
    static
    {
        ...
        ctx = new ClassPathXmlApplicationContext("classpath:mybatis/MyBatis05_05/applicationContext.xml");
    }
