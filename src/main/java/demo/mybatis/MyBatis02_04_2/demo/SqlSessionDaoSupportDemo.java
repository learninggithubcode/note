package demo.mybatis.MyBatis02_04_2.demo;

import demo.mybatis.MyBatis02_04_2.domain.Student;
import demo.mybatis.MyBatis02_04_2.service.StudentService;
...
public class SqlSessionDaoSupportDemo
{
    ...
    static
    {
        ...
        ctx = new ClassPathXmlApplicationContext("classpath:mybatis/MyBatis02_04_2/applicationContext.xml");
    }
