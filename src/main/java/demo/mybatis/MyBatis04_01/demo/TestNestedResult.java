package demo.mybatis.MyBatis04_01.demo;
import java.util.List;

import demo.mybatis.MyBatis04_01.domain.Student;
import demo.mybatis.MyBatis04_01.domain.Teacher;
import demo.mybatis.MyBatis04_01.service.TeacherService;
import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;


public class TestNestedResult {
	...
	static
	{
		...
		ctx = new ClassPathXmlApplicationContext("classpath:mybatis/MyBatis04_01/applicationContext.xml");
	}
