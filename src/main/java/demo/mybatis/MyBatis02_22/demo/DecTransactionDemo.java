package demo.mybatis.MyBatis02_22.demo;
...
public class DecTransactionDemo {
    ...
    static
    {
        ...
        ctx = new ClassPathXmlApplicationContext("classpath:mybatis/MyBatis02_22/applicationContext.xml");
    }
