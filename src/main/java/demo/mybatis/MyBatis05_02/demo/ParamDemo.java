package demo.mybatis.MyBatis05_02.demo;

import java.util.List;

import demo.mybatis.MyBatis05_02.domain.Teacher;
import demo.mybatis.MyBatis05_02.service.TeacherService;
...
public class ParamDemo
{
    ...
    static
    {
        ...
        ctx = new ClassPathXmlApplicationContext("classpath:mybatis/MyBatis05_02/applicationContext.xml");
    }
